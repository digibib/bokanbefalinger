...
module Settings
  ...
  [{:title => "Anbefalinger av bøker for voksne",
   ...
   :feed => "http://anbefalinger.deichman.no/feed?subjects=http%3A%2F%2Fdata.deichman.no%2Fsubject%2Fjul&subjects=http%3A%2F%2Fdata.deichman.no%2Fsubject%2Fjuleevangeliet&subjects=http%3A%2F%2Fdata.deichman.no%2Fsubject%2Fjulemat"},
   {:title => "Anbefalte novellesamlinger",
   :feed => "http://anbefalinger.deichman.no/feed?formats=http%3A%2F%2Fdbpedia.org%2Fresource%2FShort_stories"}]
end
